      ...
      <CardContent className="pt-6">
        <Tabs.Root defaultValue="comparison">
          <Tabs.List className="w-full bg-gray-700/50 rounded-sm py-1 px-1 flex gap-2">
            <Tabs.Trigger className={TabsDesign.tabsDesign} value="comparison">
              Comparação
            </Tabs.Trigger>
            <Tabs.Trigger className={TabsDesign.tabsDesign} value="breakdown">
              Detalhamento de Custos
            </Tabs.Trigger>
            <Tabs.Trigger className={TabsDesign.tabsDesign} value="efficiency">
            ...
            <div>
              ...
              <div className="flex mt-8 justify-between gap-3">
                ...
                {costBreakdown.map((item) => (
                  <div
                    key={item.cost}
                    className="flex-1 border border-gray-700 p-3 rounded-md"
                  >
                    <span className="font-medium">Custo Total Mensal</span>
              ...
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={efficiencyData}>
                  ...
                  <Line
                    ...
                    type="monotone"
                    dataKey="costPerCall"
                    stroke="var(--color-costPerCall)"
                  />
                  <Line
                    yAxisId="right"
                    type="monotone"
                    dataKey="callsPerDollar"
                    stroke="var(--color-callsPerDollar)"
                  />
                </LineChart>
              </ResponsiveContainer>
            </ChartContainer>
