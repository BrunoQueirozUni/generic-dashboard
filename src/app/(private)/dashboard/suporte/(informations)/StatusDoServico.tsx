...
const incidents: Incident[] = [
  {
    ...
    status: "monitoring",
    description:
      "Estamos monitorando a lentidão no banco de dados. A performance está melhorando gradualmente.",
  },
  {
    id: 2,
    date: "2023-07-10",
    ...
    status: "resolved",
    description:
      "A API ficou indisponível por 15 minutos devido a um problema no servidor. O problema foi resolvido.",
  },
];
  ...
  return (
    <>
      <Card>
        ...
        <CardDescription>
          Verifique o status atual dos nossos serviços
        </CardDescription>
                  ...
                  <div className="flex gap-3">
                    ...
                    >
                      <Progress.Indicator
                        ...
                        style={{
                          transform: `translateX(-${100 - usage(item)}%)`,
                        }}
                      />
                    </Progress.Root>
                    <span className="text-sm text-gray-500 flex-1">
                      {usage(item).toFixed(2)}%
                    </span>
                  </div>
                </div>
